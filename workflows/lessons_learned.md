...
- For governance, classify query and response independently — two parallel classifier nodes, one on the query, one on the response. The routing IF fires if EITHER is SENSITIVE or UNCERTAIN.
