...
For n8n-specific syntax and runtime rules, read `n8n_SKILL.md`. For n8n session-story lessons (Merge node behavior, dedup, execution-order), read `n8n-workflows/lessons_learned.md`.
